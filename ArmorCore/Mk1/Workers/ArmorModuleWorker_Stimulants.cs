...
{
    public class ArmorModuleWorker_Stimulants : MKArmorModule
    {
        public override string StatDescription()
        {
            string result = string.Format("ArmorModuleWorker_Stimulants".Translate(), def.StatAffecter.ToArrayValues());
