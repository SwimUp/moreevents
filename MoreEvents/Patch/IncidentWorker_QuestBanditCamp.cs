...
namespace MoreEvents.Patch
{
    ...
    public class IncidentWorker_QuestBanditCamp : IncidentWorker
    {
        ...
        protected override bool TryExecuteWorker(IncidentParms parms)
        {
            ...
            Quest_BanditCamp quest = new Quest_BanditCamp(text, site);
            quest.TicksToPass = randomInRange * 60000;
            quest.Target = site;
