...
namespace MoreEvents.Patch
{
    ...
    public class IncidentWorker_QuestItemStash : IncidentWorker
    {
        ...
        protected override bool TryExecuteWorker(IncidentParms parms)
        {
            ...
            EmailMessage message = QuestsManager.Communications.PlayerBox.FormMessageFrom(faction, letterText, def.letterLabel);
            QuestsManager.Communications.PlayerBox.SendMessage(message, false);
