...
{
    public static class ThingDefGenerator_BuildingsCustom
    {
        ...
        public static ThingDef BaseBlueprintDef()
        {
        ...
        public static ThingDef BaseFrameDef()
        {
            ThingDef thingDef = new ThingDef();
        ...
        public static ThingDef NewBlueprintDef_Terrain(TerrainDef terrDef)
        {
            ThingDef thingDef = BaseBlueprintDef();
        ...
        public static ThingDef NewFrameDef_Terrain(TerrainDef terrDef)
        {
            ThingDef thingDef = BaseFrameDef();
