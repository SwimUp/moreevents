...
{
    public class CaravanAI_NeedsTracker : IExposable
    {
        ...
        public CaravanAI_NeedsTracker()
        {
        }

        public CaravanAI_NeedsTracker(Caravan caravan)
        {
        ...
        {
            if (food.CurLevelPercentage < 0.4f)
            {
